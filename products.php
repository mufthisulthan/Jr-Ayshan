...
<head>
    ...
    <title>Products — JR MARKETING (PVT) LTD</title>
...
<body>
            ...
            <div class="sidebar-inner">
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-item open" data-menu="products">
                        ...
                        <ul class="submenu">
                            <li><a class="submenu-link active" href="products.php">&#8227;&nbsp; Products List</a></li>
                            <li><a class="submenu-link" href="products.php#add" onclick="switchTab('add'); return false;">&#8227;&nbsp; Add New Product</a></li>
                    ...
                    <div class="form-card">
                        ...
                        <div class="form-grid-2">
                            ...
                            <div class="form-field">
                                <label class="form-label" for="f-sku">
                                    SKU <span class="info-badge" title="Stock Keeping Unit — unique product identifier">i</span>
                                </label>
                        ...
                        <div class="editor-wrap">
                            <div class="editor-toolbar">
                                ...
                                <button type="button" class="etb-btn" onclick="document.execCommand('insertUnorderedList')">• List</button>
                                <button type="button" class="etb-btn" onclick="document.execCommand('justifyLeft')">≡L</button>
                                <button type="button" class="etb-btn" onclick="document.execCommand('justifyCenter')">≡C</button>
                            </div>
    ...
    <div class="xl-overlay" id="xl-overlay" role="dialog" aria-modal="true" aria-labelledby="xl-title">
        <div class="xl-modal">
            ...
            <div class="xl-header">
                ...
                <button class="xl-close" id="xl-close-btn" title="Close">✕</button>
            </div>
            ...
            <div class="xl-body">
                ...
                <div class="xl-drop-zone" id="xl-drop-zone">
                    ...
                    <div class="xl-drop-hint">or <span id="xl-browse-link">browse to upload</span> &nbsp;·&nbsp; Supports .xlsx, .xls, .csv</div>
                </div>
    ...
    function processXlFile(file) {
        ...
        reader.onload = function(e) {
            try {
                ...
                const colMap    = {}; // xlCol.key → fileColumnIndex
                XL_COLS.forEach(col => {
                ...
                /* Build rows — normalize values from legacy systems */
    ...
    /* ── Validate a single row, writing errors into row._errors ── */
    ...
    function renderXlGrid() {
        ...
        document.getElementById('xl-grid-body').innerHTML = xlRows.map((row, ri) => {
            ...
            return `<tr class="${hasErr ? 'row-error' : ''}" id="xl-row-${ri}">
                ...
                ${cells}
                <td><button class="row-del-btn" title="Remove row" onclick="xlDeleteRow(${ri})">✕</button></td>
            </tr>`;
        }).join('');
        ...
        <div class="xl-overlay open" id="edit-prod-overlay" style="z-index:950" onclick="if(event.target===this)closeEditProduct()">
            <div class="xl-modal" style="max-width:600px">
                <div class="xl-header">
                    ...
                    <button class="xl-close" onclick="closeEditProduct()">✕</button>
                </div>
