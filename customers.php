...
<head>
    ...
    <title>JR MARKETING (PVT) LTD — Customers</title>
...
<body>
    <nav class="navbar">
        ...
        <div class="navbar-right">
            <button class="nav-pos-btn" onclick="location.href='pos.php'"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" stroke="currentColor" stroke-width="2.2" viewBox="0 0 24 24"><rect x="2" y="3" width="20" height="14" rx="2"/><line x1="8" y1="21" x2="16" y2="21"/><line x1="12" y1="17" x2="12" y2="21"/></svg> POS</button>
    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar"><div class="sidebar-inner"><ul class="sidebar-menu">
            ...
            <li class="menu-item" data-menu="purchases"><div class="menu-link" onclick="toggleMenu('purchases')"><span class="menu-link-left"><span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="8 17 12 21 16 17"/><line x1="12" y1="12" x2="12" y2="21"/></svg></span>Purchases</span><span class="menu-chevron">&#9654;</span></div><ul class="submenu"><li><a class="submenu-link" href="purchases.php">&#8227;&nbsp; Purchase List</a></li><li><a class="submenu-link" href="purchases.php#add">&#8227;&nbsp; Add Purchase</a></li><li><a class="submenu-link" href="purchases.php#return">&#8227;&nbsp; Purchase Return</a></li></ul></li>
            <li class="menu-item" data-menu="sell"><div class="menu-link" onclick="toggleMenu('sell')"><span class="menu-link-left"><span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><polyline points="17 1 21 5 17 9"/><path d="M3 11V9a4 4 0 0 1 4-4h14"/></svg></span>Sell</span><span class="menu-chevron">&#9654;</span></div><ul class="submenu"><li><a class="submenu-link" href="sales.php">&#8227;&nbsp; All Sales</a></li><li><a class="submenu-link" href="add-sale.php">&#8227;&nbsp; Add Sale</a></li><li><a class="submenu-link" href="sale-return.php">&#8227;&nbsp; Sale Return</a></li><li><a class="submenu-link" href="sales.php#quotations">&#8227;&nbsp; Quotations</a></li><li><a class="submenu-link" href="sales.php#credit">&#8227;&nbsp; Credit Sales</a></li><li><a class="submenu-link" href="sales.php#cheques">&#8227;&nbsp; Cheques</a></li></ul></li>
                ...
                <div class="tab-content active" id="tab-list">
                    <div class="card">
                        <div class="toolbar">
                            ...
                            <button class="btn btn-primary" onclick="Importer.showModal('customers')" style="background:linear-gradient(135deg,#2563eb,#3b82f6)">📤 Import Data</button>
                        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="ac-section">
                            ...
                            <div class="form-actions">
                                ...
                                <button class="btn btn-primary" onclick="saveCustomer()" style="height:38px;padding:0 24px">💾 Save Customer</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="view-overlay" id="view-overlay">
        <div class="view-modal">
            <div class="view-header"><h2 id="view-title">Customer Details</h2><button class="view-close" id="view-close" title="Close">✕</button></div>
    ...
    function viewCustomer(id) {
        ...
        if (!c) return;
        const addr = [c.addr1, c.city, c.state, c.zip].filter(Boolean).join(', ') || c.address || '—';
        ...
        if (c.type === 'business') {
            rows += `<div class="view-row"><div class="view-label">Business Name</div><div class="view-val">${c.businessName || '—'}</div></div>`;
        } else {
        ...
        rows += `
            ...
            <div class="view-row"><div class="view-label">Mobile</div><div class="view-val">+94 ${c.mobile || c.phone || '—'}</div></div>
            <div class="view-row"><div class="view-label">Alternate Number</div><div class="view-val">${c.altNumber || '—'}</div></div>
            <div class="view-row"><div class="view-label">Landline</div><div class="view-val">${c.landline || '—'}</div></div>
            <div class="view-row"><div class="view-label">Email</div><div class="view-val">${c.email || '—'}</div></div>
            <div class="view-row"><div class="view-label">Assigned To</div><div class="view-val">${c.assignedTo || '—'}</div></div>
            <div style="height:8px"></div>
