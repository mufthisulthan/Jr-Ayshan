...
<head>
    ...
    <title>JR MARKETING (PVT) LTD — Profit / Loss</title>
...
<body>
    ...
    <div class="layout">
        <aside class="sidebar" id="sidebar"><div class="sidebar-inner"><ul class="sidebar-menu">
            ...
            <li class="menu-item open" data-menu="reports"><div class="menu-link active" onclick="toggleMenu('reports')"><span class="menu-link-left"><span class="menu-icon"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg></span>Reports</span><span class="menu-chevron">&#9654;</span></div><ul class="submenu"><li><a class="submenu-link active" href="profit-loss.php">&#8227;&nbsp; Profit / Loss</a></li><li><a class="submenu-link" href="purchase-report.php">&#8227;&nbsp; Purchase Report</a></li><li><a class="submenu-link" href="sales-report.php">&#8227;&nbsp; Sales Report</a></li><li><a class="submenu-link" href="expense-report.php">&#8227;&nbsp; Expense Report</a></li><li><a class="submenu-link" href="stock-report.php">&#8227;&nbsp; Stock Report</a></li><li><a class="submenu-link" href="tax-report.php">&#8227;&nbsp; Tax Report</a></li></ul></li>
        </ul></div></aside>
        <main class="main">
            <div class="content-header"><div class="page-title">📊 Profit / Loss Report</div></div>
            <div class="content-body">
                <div class="toolbar"><label style="font-size:13px;font-weight:600">From</label><input type="date" id="date-from" onchange="generateReport()"><label style="font-size:13px;font-weight:600">To</label><input type="date" id="date-to" onchange="generateReport()"><button class="btn btn-primary" onclick="generateReport()">Generate</button><button class="btn btn-outline" onclick="printReport()">🖨 Print</button></div>
                <div class="stats-row">
