...
<head>
    ...
    <title>JR MARKETING (PVT) LTD â€” Dashboard</title>
...
<body>
            ...
            <div class="sidebar-inner">
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-item" data-menu="products">
                        ...
                        <ul class="submenu">
                            <li><a class="submenu-link" href="{{ url('/products') }}">&#8227;&nbsp; Products List</a></li>
                            <li><a class="submenu-link" href="{{ url('/products') }}#add">&#8227;&nbsp; Add New Product</a></li>
        ...
        <main class="main" role="main">
            ...
            <div class="content-header">
                <div class="welcome-text">
                    Welcome&nbsp;<span id="welcome-name">Admin</span> &nbsp;ðŸ‘‹
                </div>
            ...
            <div style="padding: 0 20px 6px; background: #eef1f8;">
                <div class="stock-alert-wrap">
                    <div class="stock-alert-header">
                        ...
                        <a class="stock-alert-link" href="{{ url('/stock-report') }}">View Stock Report â†’</a>
                    </div>
                    <div id="sa-body">
            ...
            <div class="quick-actions-wrap">
                ...
                <div class="qa-grid">
                    ...
                    <a class="qa-card qa-blue" href="{{ url('/pos') }}" title="Open Point of Sale">
                        <div class="qa-icon">
                    ...
                    <a class="qa-card qa-green" href="{{ url('/products') }}#add" title="Add New Product">
                        <div class="qa-icon">
                            <svg width="26" height="26" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                <path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/>
                    ...
                    <a class="qa-card qa-purple" href="{{ url('/payments') }}" title="View Payments">
                        <div class="qa-icon">
                            <svg width="26" height="26" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                <rect x="1" y="4" width="22" height="16" rx="2"/>
                                <line x1="1" y1="10" x2="23" y2="10"/>
                    ...
                    <a class="qa-card qa-orange" href="{{ url('/expenses') }}#add" title="Add Expense" id="qa-expense">
                        <div class="qa-icon">
                            <svg width="26" height="26" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                                <rect x="1" y="4" width="22" height="16" rx="2" ry="2"/>
                                <line x1="1" y1="10" x2="23" y2="10"/>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function loadStats(fromDate, toDate) {
            ...
            /* Net = Total Sales âˆ’ Total Purchase âˆ’ Expense */
        ...
        function loadStockAlerts() {
            ...
            tbody.innerHTML = alertItems.map((p, i) => {
                ...
                return `<tr>
                    <td>${i + 1}</td>
                    <td><strong>${p.name || 'â€”'}</strong></td>
                    <td><span class="sa-sku">${p.sku || 'â€”'}</span></td>
        ...
        /* â”€â”€ Initial load: default to "Today" â”€â”€ */
