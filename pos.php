...
<head>
    ...
    <title>POS — JR MARKETING (PVT) LTD</title>
...
<body>
    ...
    <div class="pos-topbar">
        ...
        <div class="pos-topbar-right">
            <!-- Back to Dashboard -->
            <button class="tb-btn" title="Back to Dashboard" onclick="window.location.href='dashboard.php'">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th style="text-align:center">
                                <span style="font-size:20px;font-weight:700;line-height:1;">✕</span>
                            </th>
                        </tr>
                    </thead>
    ...
    <div class="mp-overlay" id="mp-overlay" role="dialog" aria-modal="true" aria-labelledby="mp-title">
        <div class="mp-modal">
            ...
            <div class="mp-header">
                ...
                <button class="mp-close" id="mp-close" title="Close">✕</button>
            </div>
    ...
    <div class="ac-overlay" id="ac-overlay" role="dialog" aria-modal="true" aria-labelledby="ac-title">
        <div class="ac-modal">
            ...
            <div class="ac-header">
                ...
                <button class="ac-close" id="ac-close" title="Close">✕</button>
            </div>
    ...
    <div class="disc-overlay" id="disc-overlay" role="dialog" aria-modal="true" aria-labelledby="disc-title">
        <div class="disc-modal">
            <div class="disc-header">
                ...
                <button class="disc-close" id="disc-close" title="Close">✕</button>
            </div>
            <div class="disc-body">
                <!-- Product name display -->
                <div class="disc-product-name" id="disc-product-name">—</div>

                <!-- Type selector -->
                <div class="disc-type-row">
                    <label class="disc-type-label">
                        <input type="radio" name="disc-type" value="fixed" id="disc-fixed" checked/>
                        <span class="disc-type-icon">🔒</span> Fixed Amount
                    </label>
                    <label class="disc-type-label">
                ...
                <div class="disc-preview" id="disc-preview">
                    Discount: <strong id="disc-preview-val">—</strong> off this product
                </div>
            </div>
    ...
    <div class="disc-overlay" id="sd-overlay" role="dialog" aria-modal="true">
        <div class="disc-modal">
            <div class="disc-header">
                ...
                <button class="disc-close" id="sd-close" title="Close">✕</button>
            </div>
            <div class="disc-body">
                ...
                <div class="disc-preview" id="sd-preview">
                    Discount: <strong id="sd-preview-val">—</strong> off the order total
                </div>
            </div>
            <div class="disc-footer">
    ...
    <div class="sc-overlay" id="draft-overlay" role="dialog" aria-modal="true">
        <div class="sc-modal" id="draft-modal">
            <div class="sc-header">
                ...
                <button class="sc-header-close" id="draft-close-btn">✕</button>
            </div>
    ...
    <div class="sc-overlay" id="quotation-overlay" role="dialog" aria-modal="true">
        <div class="sc-modal" id="quotation-modal">
            <div class="sc-header">
                ...
                <button class="sc-header-close" id="quotation-close-btn">✕</button>
            </div>
            <div class="sc-body">
                ...
                <div class="sc-field">
                    ...
                    <textarea class="sc-textarea" id="quo-note" placeholder="e.g. Valid for 7 days · Terms &amp; conditions..."></textarea>
                </div>
                <div class="sc-field">
    ...
    <div class="sc-overlay" id="suspend-overlay" role="dialog" aria-modal="true">
        <div class="sc-modal" id="suspend-modal">
            <div class="sc-header">
                ...
                <button class="sc-header-close" id="suspend-close-btn">✕</button>
            </div>
    ...
    <div class="sc-overlay" id="credit-overlay" role="dialog" aria-modal="true">
        <div class="sc-modal" id="credit-modal">
            <div class="sc-header">
                ...
                <h3>Credit Sale</h3>
                <button class="sc-header-close" id="credit-close-btn">✕</button>
            </div>
    ...
    <div id="ae-overlay" role="dialog" aria-modal="true" aria-labelledby="ae-title">
        <div class="ae-modal">
            ...
            <div class="ae-header">
                ...
                <button class="ae-header-close" id="ae-close-btn">✕</button>
            </div>
            ...
            <div class="ae-body">
                ...
                <div class="ae-grid-2">
                    ...
                    <div class="ae-field">
                        ...
                        <textarea class="ae-textarea" id="ae-title-input" placeholder="e.g. Office Supplies, Electricity Bill, Staff Meal…" style="height:64px;"></textarea>
                ...
                <div class="ae-grid-2">
                    <div class="ae-field" style="grid-column:1/-1;">
                        ...
                        <textarea class="ae-textarea" id="ae-note" placeholder="Optional details about this expense…" style="height:64px;"></textarea>
                    </div>
                </div>
                ...
                <div class="ae-field" id="ae-bank-field" style="display:none;max-width:280px;">
                    ...
                    <input class="ae-input" type="text" id="ae-bank-ref" placeholder="e.g. Bank of Ceylon · ACC-001"/>
                </div>

                <!-- Payment Note -->
                <div class="ae-field">
                    <label class="ae-label">Payment Note</label>
                    <textarea class="ae-textarea" id="ae-pay-note" placeholder="Optional note for this payment…"></textarea>
                </div>
    ...
    <div id="ap-overlay" role="dialog" aria-modal="true" aria-labelledby="ap-title">
        <div class="ap-modal">
            ...
            <div class="ap-header">
                ...
                <button class="ap-header-close" id="ap-close-btn" title="Close">✕</button>
            </div>
                ...
                <div class="ap-field">
                    ...
                    <div class="ap-editor-wrap">
                        <div class="ap-editor-toolbar">
                            ...
                            <button type="button" class="ap-tb-btn" onclick="document.execCommand('insertUnorderedList')" title="Bullet list">• List</button>
                            <button type="button" class="ap-tb-btn" onclick="document.execCommand('justifyLeft')" title="Align Left">≡L</button>
                            <button type="button" class="ap-tb-btn" onclick="document.execCommand('justifyCenter')" title="Align Centre">≡C</button>
                        </div>
    ...
    <div class="bill-overlay" id="bill-overlay" role="dialog" aria-modal="true">
        <div class="bill-modal">
            <div class="bill-toolbar">
                <span class="bill-toolbar-title">📄 Invoice Preview</span>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        function renderCart() {
            ...
            cartItems.forEach((item, idx) => {
                ...
                tr.innerHTML = `
                    ...
                    <td style="text-align:center">
                        <button class="remove-row-btn" onclick="removeItem(${idx})">✕</button>
                    </td>
                `;
        ...
        function openBill(paymentMethod) {
            ...
            if (custMatch) {
                custMobile = custMatch.mobile ? ('+94' + custMatch.mobile) : '—';
                custClientId = custMatch.contactId || '—';
            }

            /* Sales Rep = logged-in user */
            const session = Auth.getSession();
            const salesRep = session && session.user ? session.user.name : '—';
            ...
            cartItems.forEach((item, idx) => {
                ...
                if (discAmt > 0) {
                    const dLabel = item.discount.type === 'percentage'
                        ? `Disc: ${item.discount.value}% (−LKR ${fmt(discAmt)})`
                        : `Disc: −LKR ${fmt(discAmt)}`;
        ...
        document.getElementById('btn-recent-tx').addEventListener('click', () => {
            Toast.info('Recent transactions — coming soon.');
        });
            ...
            div.innerHTML = `
                <div class="mp-row-top">
                    ...
                    <button class="mp-delete-row-btn" onclick="mpDeleteRow(${id})" title="Remove row"
                            ${mpRowCount === 1 ? 'style="visibility:hidden"' : ''}>✕</button>
                </div>
                    ...
                    <div class="mp-field">
                        ...
                        <div class="mp-cheque-status">
                            <label>
                                ...
                                <span class="mp-passed-badge">✓ Yes, Received</span>
                            </label>
                            <label>
                                <input type="radio" name="mp-got-cheque-${id}" value="No"/>
                                <span class="mp-bounced-badge">✗ Not Yet</span>
                            </label>
                        </div>
                    </div>
                    <div class="mp-field">
                        ...
                        <div class="mp-cheque-status">
                            <label>
                                ...
                                <span style="display:inline-block;padding:4px 12px;border-radius:99px;font-size:12px;font-weight:600;background:#fef3c7;color:#92400e;cursor:pointer;">⏳ Pending</span>
                            </label>
                            <label>
                                <input type="radio" name="mp-cheque-status-${id}" value="Passed"/>
                                <span class="mp-passed-badge">✓ Passed</span>
                            </label>
                            <label>
                                <input type="radio" name="mp-cheque-status-${id}" value="Bounced"/>
                                <span class="mp-bounced-badge">✗ Bounced</span>
                            </label>
                        </div>
                    </div>
                </div>
        ...
        function scSummaryHTML() {
            ...
            return `
                ...
                ${discount > 0 ? `<div class="sc-summary-row"><span>Discount</span><span style="color:#dc2626">− ${scFmt(discount)}</span></div>` : ''}
        ...
        function renderDraftModal() {
            ...
            if (!scCartEmpty()) {
                ...
                <div class="sc-field">
                    ...
                    <input class="sc-input" type="text" id="draft-note-input" placeholder="e.g. Customer will return tomorrow…"/>
                </div>`;
            }
            ...
            if (drafts.length > 0) {
                ...
                drafts.slice().reverse().forEach(d => {
                    ...
                    <div class="draft-slot">
                        <div>
                            <div class="slot-info">${d.id} · ${d.customer}</div>
                            <div class="slot-meta">${date} · ${items} item(s) · ${scFmt(d.totalPayable)}</div>
        ...
        document.getElementById('draft-save-btn').addEventListener('click', () => {
            if (scCartEmpty()) { Toast.warning('Cart is empty — nothing to save.'); return; }
            const custOpt  = scSelectedCustomer();
            const customer = custOpt ? custOpt.value || 'Walk-In Customer' : 'Walk-In Customer';
            ...
            if (list.length > 0) {
                ...
                list.slice().reverse().forEach((s, ri) => {
                    ...
                    <div class="susp-slot">
                        ...
                        <div class="susp-slot-items">${s.customer} · ${items} item(s) · ${scFmt(s.totalPayable)}</div>
        ...
        document.getElementById('suspend-save-btn').addEventListener('click', () => {
            if (scCartEmpty()) { Toast.warning('Cart is empty — nothing to suspend.'); return; }
            const custOpt  = scSelectedCustomer();
            const customer = custOpt ? custOpt.value || 'Walk-In Customer' : 'Walk-In Customer';
            const suspended = {
                id:           'SUS-' + Date.now(),
        ...
        document.getElementById('credit-confirm-btn').addEventListener('click', () => {
            ...
            if (unpaid.length > 0) {
                if (confirmBtn.dataset.confirmed === '0') {
                    /* First confirm */
                    if (!confirm(`⚠️ ${custName} has ${unpaid.length} unpaid credit sale(s) totalling ${scFmt(totalUnpaid)}.\n\nAre you sure you want to allow another credit sale?`)) return;
    ...
    <div class="ds-overlay" id="ds-overlay">
        <div class="ds-modal">
            ...
            <div class="ds-footer">
                ...
                <button class="ds-btn ds-btn-exit" onclick="closeDailySummary(); window.location.href='dashboard.php'">Close &amp; Exit POS</button>
            </div>
        </div>
    </div>
        ...
        if (todayExpenses.length === 0) {
            ...
            todayExpenses.forEach(exp => {
                html += `<div class="ds-expense-item">
                    <span class="ds-exp-title">${exp.title || exp.ref || '—'}</span>
                    <span class="ds-exp-amount">− ${dsFmt(exp.totalAmount)}</span>
                </div>`;
            });
            html += `</div>
        ...
        html += `<div class="ds-section" style="margin-bottom:0;">
            ...
            <div class="ds-stat-grid">
                <div class="ds-stat" style="grid-column:1/-1;background:${netAmount >= 0 ? '#f0fdf4' : '#fef2f2'};border-color:${netAmount >= 0 ? '#bbf7d0' : '#fecaca'};">
                    <div class="ds-stat-label">Net (Cash Received − Expenses)</div>
