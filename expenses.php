...
<head>
    ...
    <title>Expenses — JR MARKETING (PVT) LTD</title>
...
<body>
            ...
            <div class="sidebar-inner">
                <ul class="sidebar-menu">
                    ...
                    <li class="menu-item" data-menu="products">
                        ...
                        <ul class="submenu"><li><a class="submenu-link" href="products.php">&#8227;&nbsp; Products List</a></li><li><a class="submenu-link" href="products.php#add">&#8227;&nbsp; Add New Product</a></li><li><a class="submenu-link" href="units.php">&#8227;&nbsp; Units</a></li><li><a class="submenu-link" href="stock.php">&#8227;&nbsp; Stock</a></li></ul>
                    </li>
                    ...
                    <li class="menu-item" data-menu="sell">
                        ...
                        <ul class="submenu"><li><a class="submenu-link" href="sales.php">&#8227;&nbsp; All Sales</a></li><li><a class="submenu-link" href="add-sale.php">&#8227;&nbsp; Add Sale</a></li><li><a class="submenu-link" href="sale-return.php">&#8227;&nbsp; Sale Return</a></li><li><a class="submenu-link" href="sales.php#quotations">&#8227;&nbsp; Quotations</a></li><li><a class="submenu-link" href="sales.php#credit">&#8227;&nbsp; Credit Sales</a></li><li><a class="submenu-link" href="sales.php#cheques">&#8227;&nbsp; Cheques</a></li></ul>
                    </li>
                    <li class="menu-item open" data-menu="expenses">
                        ...
                        <ul class="submenu">
                            <li><a class="submenu-link active" href="expenses.php">&#8227;&nbsp; Expense List</a></li>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        /* Listen for hash changes when already on expenses.php */
    ...
    function renderList() {
        ...
        tbody.innerHTML = items.map((e, i) => `
            <tr>
                ...
                <td><span style="font-size:11.5px;background:#f3e8ff;color:#7c3aed;padding:2px 8px;border-radius:4px;font-weight:600;">${e.category || '—'}</span></td>
                ...
                <td style="font-size:12px;color:#6b7280;max-width:150px;">${e.note || '—'}</td>
                <td>
